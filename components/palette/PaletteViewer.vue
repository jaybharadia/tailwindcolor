<template>
  ...
  >
    <div
      class="flex justify-between items-center p-4 border-b dark:border-gray-800"
    >
      <h3 class="text-lg font-semibold">Generated Palette</h3>
      <div class="flex gap-2">
        <UButton :to="`/visualizer?color=${encodeURIComponent(baseColor)}`">
          Live Preview
        </UButton>
        <UButton
          color="gray"
    ...
    <div
      class="sm:hidden fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-900 border-t dark:border-gray-800"
    >
      <UButton
        block
        color="gray"
